	...
	$(document).ready(function() {
		...
		$("#saveBtn").on("click", function() {
			...
			$.ajax({
				...
				type:"PUT"
				, url:"/post/update"
				, data:formData  // 내가 보내는게 스트링으로 보내는것이 아님
				, enctype:"multipart/form-data" // 파일 업로드를 위한 필수 설정 (이미지)
				, processData:false //파일 업로드를 위한 필수 설정 (스트링이 아니라 폼이다)
				, contentType:false //파일 업로드를 위한 필수 설정 (스트링이 아니라 폼이다)
				// response
